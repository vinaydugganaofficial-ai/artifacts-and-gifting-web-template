...
export function HeritageIntro({
  ...
  return (
    <section
      ...
      className="relative scroll-mt-24 overflow-hidden bg-off-white px-5 py-24 md:px-8 md:py-32 lg:px-12"
    >
      <div className="mx-auto grid max-w-[1440px] items-end gap-12 lg:grid-cols-12 lg:gap-8">
        <Reveal className="lg:col-span-7">
          ...
          <h2 className="mt-5 max-w-[14ch] font-display text-5xl font-medium leading-[1.05] tracking-[-0.03em] text-forest sm:text-6xl lg:text-[5.4rem]">
            {title}
          </h2>
        </Reveal>
        ...
        <Reveal className="lg:col-span-5 lg:pb-4" delay={0.12}>
          ...
          <p className="max-w-md text-[17px] leading-relaxed text-deep-brown/80">{lede}</p>
          <p className="mt-6 max-w-md text-sm leading-relaxed text-deep-brown/65">
            {support}
          </p>
