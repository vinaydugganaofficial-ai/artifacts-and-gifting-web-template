...
export default async function AccountSettingsPage() {
  ...
  return (
    <div>
      ...
      <section className="mt-16 border-t border-deep-brown/15 pt-12">
        <h2 className="font-display text-2xl text-forest">How you sign in</h2>
        <span className="mt-4 block h-px w-10 bg-terracotta" aria-hidden />
        <div className="mt-8">
      ...
      <section className="mt-16 border-t border-deep-brown/15 pt-12">
        <h2 className="font-display text-2xl text-forest">Your data & Privacy</h2>
        <span className="mt-4 block h-px w-10 bg-terracotta" aria-hidden />
        ...
        <p className="mt-6 max-w-xl text-[15px] leading-relaxed text-deep-brown/80">
          ...
          have it erased. Write to the Viraasat concierge and we will answer within thirty days.
        </p>

        <p className="mt-6 text-sm text-deep-brown/65">
          What we keep and for how long is set out in our{" "}
          <Link href="/privacy" className="link-underline font-medium text-forest hover:text-terracotta">
            privacy policy
          </Link>
          .
        </p>
